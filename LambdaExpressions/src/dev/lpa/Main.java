...
public class Main {
    public static void main(String[] args) {
        ...
        cords.forEach(s -> processPoint(s[0], s[1], (lat, lng) -> System.out.printf("[lat:%.3f lon:%.3f]%n", lat, lng)));
        ...
        String[] values = {"Badrinath","Rameshwaram","DwarkaDhish","JagganathPuri"};
        String[] randomList = randomlySelectedValues(15,values,() -> new Random().nextInt(0, values.length));
        System.out.println(Arrays.toString(randomlySelectedValues(4,values,() -> 2)));
